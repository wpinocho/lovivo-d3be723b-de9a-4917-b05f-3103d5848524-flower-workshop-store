...
export const EcommerceTemplate = ({
  ...
  const footer = (
    <div className={`bg-gradient-to-br from-primary via-purple-600 to-secondary text-white py-16 ${footerClassName}`}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            <div className="flex items-center gap-3 mb-2">
              <img 
                src="https://ptgmltivisbtvmoxwnhd.supabase.co/storage/v1/object/public/product-images/d3be723b-de9a-4917-b05f-3103d5848524/logo-transparent.png"
        ...
        <div className="mt-12 pt-8 border-t border-white/20 text-center text-white/90">
          <p>&copy; 2024 Talleres de Flores. Todos los derechos reservados.</p>
        </div>
      </div>
    </div>
  )
